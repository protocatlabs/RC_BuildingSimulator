...
class Building(object):
    ...
    def solve_building_energy(self, internal_gains, solar_gains, T_out, T_m_prev):
        ...
        :return: self.heatingSysElectricity, heating electricity consumption
        :return: self.heatingSysFossils, heating fossil fuel consumption 
        ...
        :return: self.COP, COP of the heating or cooling system
        :rtype: float
        ...
        self.sysTotalEnergy = self.heatingSysElectricity + self.heatingSysFossils + \
            self.coolingSysElectricity + self.coolingSysFossils
    ...
    def calc_heat_flow(self, T_out, internal_gains, solar_gains, energy_demand):
        ...
        emDirector.setBuilder(self.heatingEmissionSystem(
