...
#Initialise an instance of the building. Empty spaces take on the default parameters. See buildingPhysics.py to see the default values
...
for hour in range(8760):
	...
	Office.solve_building_energy(internal_gains=internal_gains, solar_gains=SouthWindow.solar_gains,T_out=T_out, T_m_prev=T_m_prev)
