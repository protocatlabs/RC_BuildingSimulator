...
class TestBuildingSim(unittest.TestCase):
    ...
    def test_NoHVACNoLight(self):
        ...
        Office = sc.sticky["RC_Zone"](window_area=13.5,
...
# ############################ System Variations ########################
    ...
    def test_WaterHeatPumpCoolingRequired(self):
        ...
        Office = sc.sticky["RC_Zone"](window_area=13.5,
                          ...
                          max_heating_energy_per_floor_area=12,
                          heating_supply_system=sc.sticky["DirectHeater"],
                          cooling_supply_system=sc.sticky["HeatPumpWater"],
                          heating_emission_system=sc.sticky["AirConditioning"],
                          cooling_emission_system=sc.sticky["AirConditioning"],
                          )
...
if run_tests:
    Test = TestBuildingSim()
    Test.test_WaterHeatPump_HeatingRequired_Infl()