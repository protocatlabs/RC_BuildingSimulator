...
Office = Building(window_area=200.0,
...
WestWindow = Window(azimuth_tilt=270, alititude_tilt=90, glass_solar_transmittance=0.19,
										 glass_light_transmittance=0.1, area=58.1)

NorthWindow = Window(azimuth_tilt=180, alititude_tilt=90, glass_solar_transmittance=0.19,
										 glass_light_transmittance=0.1, area=87.1)
